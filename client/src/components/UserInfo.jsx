...
function UserInfo() {
    ...
    const onSubmit = handleSubmit(async (data) => {
        try {
           updateUser(params.id, data); // Espera a que se complete la actualización// Espera a que se complete la creación
    ...
    return (
        ...
        <div className="bg-zinc-900 max-w-md w-full p-10 rounded-md">
            ...
            <h1 className= "text-3xl text-white font-bold my-2">Editar usuario</h1>
            {/* Formulario */}
            <form onSubmit={onSubmit}>
                ...
                <label className="text-white">Rol</label>
                    <select
                        ...
                        className="w-full bg-white-700 text-black px-4 py-2 rounded-md my-2"
                    >
                        <option value="">Select Role</option> {/* Opción por defecto */}
