...
function CounselingFormPage() {
  ...
  console.log("Teacher dropped:", teacher); // <- Agrega esto

  // Si teacher es solo el id, busca el objeto:
  const foundTeacher = typeof teacher === "string"
        ...
        <div className="p-4">
            ...
            <div className="flex space-x-4 mb-4">
                <div>
                    ...
                    <select
                        className="text-gray-500 border p-2 round w-full"
